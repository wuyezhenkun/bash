...
## general_pipeline comand 1  (mapping)
...
## general_pipeline comand 2  (CatToMat)
...
## general_pipeline comand 3  (filtering)
...
## general_pipeline comand 4  (biclustering)
...
## general_pipeline comand 5  (enrichment)
